  ...
  <div>
    <div className="grid gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
      ...
      <figure className="relative min-h-[540px] overflow-hidden rounded-[7px] border border-[#bdb6ab] bg-[#ded9d0] lg:min-h-[620px]">
        <Image src="/images/store/big-wicks-storefront-front.jpg" alt="Front of the Big Wicks Fireworks store on IN-39 in La Porte" fill className="object-cover object-[center_24%]" sizes="(max-width: 1024px) 100vw, 60vw" />
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-7 pt-28">
          <figcaption className="text-xs font-extrabold uppercase tracking-[0.16em] text-white"><span className="mr-3 inline-block h-1 w-8 bg-(--accent) align-middle" aria-hidden="true" />Look for the red trim and Big Wicks sign</figcaption>
        </div>
      </figure>
    </div>
