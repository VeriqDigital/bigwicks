...
export default function OrderReview({ review, message, pending, onBack, onSubmit }: {
  ...
  return <section className="mx-auto max-w-4xl" aria-labelledby="order-review-title">
    <button type="button" onClick={onBack} disabled={pending} className="mb-4 min-h-12 underline disabled:opacity-50">Back to cases</button>
    ...
    <p className="mt-2 text-sm text-(--muted)">Review these current case prices and case counts. Any changes before submission will require another review.</p>
